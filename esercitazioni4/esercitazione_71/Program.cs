...
Contatto contattoSovrascritto = new Contatto
// e lo inizializzo con i valori desiderati
{
    ...
    Telefono = "800900313",
    Presente = true,
    Interessi = new List<string> { "Junior di DragonBall", "Defilippis", "Espresso Timonato" }
};
// serializzo l'oggetto in un file json
string json = JsonConvert.SerializeObject(contattoSovrascritto, Formatting.Indented);
// scrivo il json su file
File.WriteAllText(@"contatti.json", json);
